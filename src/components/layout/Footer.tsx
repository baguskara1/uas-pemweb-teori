        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-display font-semibold">Sewa Kamera Ryox</span>
            </Link>
          ...
          <div>
            <h3 className="font-display font-semibold mb-4">Menu</h3>
            <ul className="space-y-2">
              <li>
                <Link
                  href="/cameras"
                  className="font-text text-white/70 hover:text-white transition-colors"
                >
                  Katalog Kamera
                </Link>
              </li>
