...
function Row({ label, value }: { label: string; value: React.ReactNode }) {
  return (
    <div className="flex justify-between items-center py-3 border-b border-surface-light last:border-0">
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="font-display text-2xl font-semibold">Detail Booking</h1>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Booking info */}
          <div className="bg-white rounded-2xl border border-surface-light shadow-sm p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <Calendar className="h-5 w-5 text-primary" />
                <h2 className="font-display text-lg font-semibold">Info Booking</h2>
              </div>
          ...
          <div className="bg-white rounded-2xl border border-surface-light shadow-sm p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-display text-lg font-semibold">Rincian Biaya</h2>
            </div>
            <Row label="Harga Normal" value={formatCurrency(Number(booking.total_price))} />
            <Row
              label="Diskon"
              value={
                <span className={Number(booking.discount_amount) > 0 ? 'text-green-600' : ''}>
        ...
        <div className="space-y-6">
          ...
          {camera && (
            <div className="bg-white rounded-2xl border border-surface-light shadow-sm p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="font-display text-lg font-semibold">Kamera</h2>
              </div>
              {camera.image_url && (
                <img
                  src={camera.image_url}
                  alt={camera.name}
                  className="w-full h-40 object-cover rounded-xl mb-4 bg-surface-light"
                />
              )}
          ...
          {user && (
            <div className="bg-white rounded-2xl border border-surface-light shadow-sm p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="font-display text-lg font-semibold">Penyewa</h2>
              </div>
          ...
          {/* Update status */}
          <div className="bg-white rounded-2xl border border-surface-light shadow-sm p-6">
            <h2 className="font-display text-lg font-semibold mb-4">Update Status</h2>
