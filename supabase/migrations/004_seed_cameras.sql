...
insert into cameras (name, brand, type, description, price_per_day, image_url, stock, is_available) values
  ('Sony A7 IV', 'Sony', 'Mirrorless',
   ...
   250000, '/images/cameras/sony/sony-a7-iv.webp', 5, true),
  ...
  ('Sony A7S III', 'Sony', 'Mirrorless',
   ...
   300000, '/images/cameras/sony/sony-a7s-iii.webp', 3, true),
  ...
  ('Sony FX3', 'Sony', 'Cinema',
   ...
   450000, '/images/cameras/sony/sony-fx3.webp', 2, true),
  ...
  ('Canon EOS R5', 'Canon', 'Mirrorless',
   ...
   350000, '/images/cameras/canon/canon-r5.webp', 4, true),
  ...
  ('Canon EOS R6 Mark II', 'Canon', 'Mirrorless',
   ...
   220000, '/images/cameras/canon/canon-r6-mark-ii.webp', 5, true),
  ...
  ('Fujifilm X-T5', 'Fujifilm', 'Mirrorless',
   ...
   180000, '/images/cameras/fujifilm/fujifilm-x-t5.webp', 6, true),
